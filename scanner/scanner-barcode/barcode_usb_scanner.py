# Name of code artifact: barcode_usb_scanner.py 
# Brief description of what the code does: Allows usb scanner to detach from kernel to ensure security. This contains modified code from the github.com/vpatron/barcode_scanner_python repo 
# Programmer’s name: Xavier Ruyle   
# Date the code was created: N/A
...
def hid2ascii(lst):
    ...
    conv_table = {
        ...
        43:['\t', '\t'],
        44:[' ', ' '],
        45:['-', '-'], # needed to change this for some reason it would read it as _  
        # 45:['_', '_'], # needed to change this for some reason it would read it as _  
        46:['=', '+'],
        47:['[', '{'],
        48:[']', '}'],
        49:['\\', '|'],
